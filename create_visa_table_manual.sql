-- Manual SQL to create visa_requirements table
-- Copy and paste this into your Supabase SQL Editor: 
-- https://supabase.com/dashboard/project/jmbjxlijwojvavmmzpmo/sql

-- Create visa requirements table (only if it doesn't exist)
...
DROP POLICY IF EXISTS "Anyone can read visa requirements" ON public.visa_requirements;
...
DROP POLICY IF EXISTS "Authenticated users can manage visa requirements" ON public.visa_requirements;
...
SELECT COUNT(*) as total_records FROM public.visa_requirements;
